...
\begin{thebibliography}{12}
  ...
  \bibitem{Verkehrszählungen_Baden-Württemberg}
  ...
  \bibitem{Dauerzählstellen_Ergebnisse}
  \textit{Dauerzählstellen Ergebnisse}
  \url{https://mobidata-bw.de/vm/Ergebnisse_Ganglinien_Dauerzaehlstellen_BW/Ergebnisse_2023_PDF/VZ_2023_01-06.pdf}

  \bibitem{Stau_in_Karlsruhe}
  \textit{Stau in Karlsruhe, bnn}
  ...
  \bibitem{warmup}
  \textit{Why Warmup the Learning Rate? Underlying Mechanisms and Improvements}
  \url{https://arxiv.org/pdf/2406.09405}

  \bibitem{Adaptive_Exploration}
  \textit{Proximal Policy Optimization with Adaptive Exploration}
  ...
  \bibitem{OSM-Trafic-signals}
  \textit{OSM Traffic signals}
  ...
  \bibitem{mschrader15}
  \textit{Reinforcement Learning + traffic microsimulation (via SUMO)}
  \url{https://github.com/mschrader15/reinforcement-learning-sumo?tab=readme-ov-file}



  \bibitem{sumo-rl-tls}
  \textit{Sumo-rl TLS-interface}
