...
\begin{figure}[H]
    ...
    \caption{Visualisierung des aus OSM generierten SUMO-Netzes (Quelle: SUMO-Gui)}
...
\begin{figure}[H]
    ...
    \caption{Screenshot des ursprünglichen OpenStreetMap-Ausschnitts (Quelle: OpenStreetMap).}
