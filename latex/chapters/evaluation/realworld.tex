...
Auffällig ist die hohe Varianz gerade bei Modell 3 und Modell 4 in den schwierigeren Szenarien. Dort schwanken die Ergebnisse stark zwischen einzelnen Runs, was darauf hinweist, dass die Modelle teils sehr effiziente, teils aber auch deutlich weniger stabile Steuerungsstrategien hervorbringen.
...
Die stark erhöhten Werte im random\_heavy gehen mit einer hohen Streuung zwischen den Runs einher. Dies deutet darauf hin, dass die Modelle zwar häufig sehr effiziente Steuerungsstrategien finden, diese jedoch in einzelnen Durchläufen nicht stabil reproduziert werden.
...
Die Actuated-Baseline schneidet deutlich schlechter ab: mit mehreren hundert Fahrzeugen im Netz, im Extremfall fast 900, liegt sie um ein Vielfaches über der Fixed-Time-Variante und bestätigt ihre geringe Eignung.
...
Die Fixed-Time-Baseline bewegt sich in allen Szenarien auf einem soliden Niveau von rund 5½ bis 6 m/s und liegt damit klar über der Actuated-Variante. Diese erreicht nur etwa ein halbes m/s und ist damit um eine ganze Größenordnung schlechter.
