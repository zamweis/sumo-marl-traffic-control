...
\begin{tikzpicture}
    \begin{axis}[
        ...
        % Baseline Actuated
        \addplot+[ybar] table [
                x=scenario, y=system_mean_waiting_time_mean, col sep=comma,
                row predicate/.code={%
        ...
        % RL Modelle (jedes run_dir einzeln)
        % RL Modell 1
        \addplot+[ybar] table [
                x=scenario, y=system_mean_waiting_time_mean, col sep=comma,
                row predicate/.code={%
                        \ifnum\pdfstrcmp{\thisrow{method}}{RL}=0
                        \ifnum\pdfstrcmp{\thisrow{run_dir}}{ppo_sumo_234256_2025-08-11_23-33-59}=0
                        \else \pgfplotstableuserowfalse \fi \fi
                    }
            ] {chapters/evaluation/results/eval_results_agg.csv};
        \addlegendentry{RL Model 1}
        ...
        \addplot+[ybar] table [
                ...
                row predicate/.code={%
                        \ifnum\pdfstrcmp{\thisrow{method}}{RL}=0
                        \ifnum\pdfstrcmp{\thisrow{run_dir}}{ppo_sumo_345987_2025-08-12_09-22-11}=0
                        \else \pgfplotstableuserowfalse \fi \fi
                    }
            ] {chapters/evaluation/results/eval_results_agg.csv};
        \addlegendentry{RL Model 2}

        % weitere RL-Modelle genauso ergänzen...
