...
\begin{itemize}
    ...
    \item \textbf{DQN (Deep Q-Network)\cite{Deep Q-Learning}:} Kombination von Q-Learning mit neuronalen Netzen.
    \item \textbf{PPO (Proximal Policy Optimization)\cite{Proximal Policy Optimization}:} Policy-basierter RL-Ansatz mit stabiler Optimierung.
\end{itemize}
