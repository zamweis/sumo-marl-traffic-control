...
Ein RL-Prozess wird typischerweise als \gls{mdp} beschrieben und besteht aus folgenden Komponenten: \cite{bellman1957}
...
\begin{itemize}
    ...
    \item \textbf{Reza et al. (2023):} Einsatz einer TD-Learning-basierten Methode zur umfassenden stadtweiten Ampelregelung unter besonderem Fokus auf autonome Fahrzeuge. Die Leistung wird mittels SUMO-Simulationen evaluiert. \cite{reza2023}
