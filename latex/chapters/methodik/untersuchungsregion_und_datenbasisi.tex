...
\begin{itemize}
    ...
    \item \textbf{Zählstellen an äußeren Zufahrtsachsen:} Ergänzende Zähldaten aus dem Jahr 2023 an acht stark befahrenen Einfallstraßen (u.\,a. B10, B36, L605)liefern Anhaltspunkte zur Verkehrsstärke an den Netzrändern. \cite{mobidata_karte} 
\end{itemize}
