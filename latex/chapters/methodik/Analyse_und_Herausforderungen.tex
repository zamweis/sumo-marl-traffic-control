...
\begin{figure}[H]
  ...
  \caption{Visualisierung einer TLS-Kreuzung (Quelle: netedit\cite{netedit}).}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    ...
    \caption*{Nachher}
  \end{subfigure}
  \caption{Vorher-Nachher-Vergleich einer angepassten TLS-Kreuzung (Quelle: netedit \cite{netedit})}
  \label{fig:tls_fix}
\end{figure}
