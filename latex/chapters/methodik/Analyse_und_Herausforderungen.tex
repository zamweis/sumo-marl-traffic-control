...
Bevor die Probleme beim OSM-Import analysiert werden, ist es hilfreich, den Aufbau und die Abhängigkeiten der relevanten XML-Elemente in SUMO \cite{sumo-doc} zu verstehen, insbesondere im Zusammenhang mit der Steuerung von Lichtsignalanlagen.
\begin{figure}[H]
  \centering
