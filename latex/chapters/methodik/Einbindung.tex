...
Zur abschließenden Bewertung der trainierten Modelle wird ein systematischer Evaluationsplan verfolgt (Details und Ergebnisse siehe Kapitel~\ref{sec:validation}).
...
Diese Strategie stellt sicher, dass die in Kapitel~\ref{sec:validation} präsentierten Ergebnisse reproduzierbar, belastbar und auf unterschiedliche Verkehrssituationen übertragbar sind.
