...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance=1cm]
        ...
        \node[box, below=of sim] (mae) {\gls{mae}\\\texttt{sumo-rl.parallel\_env} + \texttt{emissions\_with\_speed\_reward}};
