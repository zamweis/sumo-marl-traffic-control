...
\begin{titlepage}
  ...
  % Titel
  {\LARGE\bfseries Optimierung einer Verkehrssimulation mit \\[0.2cm]
    KI-basierten Agenten in SUMO \par}
  ...
  \begin{tikzpicture}[scale=0.8, every node/.style={font=\small}]
    ...
    % Ampeln
    \foreach \pos/\col in {(-0.9,0.9)/red, (0.9,-0.9)/green,
        (0.9,0.9)/red, (-0.9,-0.9)/green} {
