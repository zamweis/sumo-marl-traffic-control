...
Hiermit erkläre ich, Sam Weiler, dass ich die vorliegende Bachelorarbeit mit dem Titel 
...
\begin{tikzpicture}[baseline]
  % Linie zeichnen
  \draw[line width=0.4pt] (0,0) -- (6,0);
  % Signatur mittig auf der Linie platzieren
  \node[inner sep=0pt, anchor=south] at (3,0) 
    {\includegraphics[height=1.5cm]{signatur_trans_blue.png}};
\end{tikzpicture}
